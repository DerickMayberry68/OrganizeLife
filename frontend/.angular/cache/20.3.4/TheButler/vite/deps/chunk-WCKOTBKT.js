      ...
      for (var rowCount = 1; rowCount <= yearCell; ++rowCount) {
        ...
        if (islamicDate.year === parseInt(startHdrYr, 10) - 1 || islamicDate.year >= startHdrYr && islamicDate.year <= endFullYr || islamicDate.year === parseInt(endHdrYr, 10) + 1) {
          ...
          if (islamicDate.year === parseInt(startHdrYr, 10) - 1 || year_1 < startFullYr || year_1 > endFullYr && islamicDate.year !== parseInt(endHdrYr, 10)) {
            ...
            if (this.getIslamicDate(localDate).year === this.getIslamicDate(this.calendarInstance.currentDate).year && !tdEle.classList.contains(DISABLED2)) {
              addClass([tdEle], FOCUSEDDATE2);
            }
          }
          if (!tdEle.classList.contains(DISABLED2)) {
...
var DatePicker = (
  ...
  (function(_super) {
    ...
    DatePicker2.prototype.inputBlurHandler = function(e) {
      ...
      var dateSame = this.value && this.previousDate ? this.value.getTime() === this.previousDate.getTime() : this.value === this.previousDate;
        ...
        if (!this.isPopupOpen()) {
          ...
          this.trigger("open", eventArgs, function(eventArgs2) {
            ...
            if (!_this.openEventArgs.cancel) {
              ...
              if (!isNullOrUndefined(_this.mobileRangePopupWrap) && !isNullOrUndefined(_this.popupObj) && !isNullOrUndefined(_this.popupObj.element) && isNullOrUndefined(_this.modal) && !isUndefined(_this.presets[0].start && _this.presets[0].end && _this.presets[0].label) && isPreset && (_this.isMobile || Browser.isDevice) && !_this.isCustomWindow) {
...
//# sourceMappingURL=chunk-WCKOTBKT.js.map
